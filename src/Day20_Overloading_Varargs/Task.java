...
class Task {
    ...
    //May 6, Lesson 3
    // 1. create a method that takes a strings and reverses it, it should return reversed string
    // 2. create a method that takes an array of strings and reverses all the strings in it,
    // it should return an array of reversed strings
    // 3. create a method that takes a 2d array of strings and reverses all the strings in it,
